...
/*
 * THe main changes in the driver from previous code
 *
 * 1.  Creates parts and sets the ambient color of the material for each part
...
static GLuint transform_loc, ambient_color_loc;
...
void init()
{
	...
	program = cs4722::load_shaders("vertex_shader01.glsl",
