...
void init(void)
{
    ...
    // rotate about the object center
...
//    obj1->animation_transform.rotation_center = glm::vec3(0, .3f, 0);
    ...
    // rotate about one end of the object
    part1->animation_transform.rotation_center =
            part1->world_transform.matrix() * glm::vec4(0, .5, 0, 1);
...
{
    glfwInit();
    auto *window = cs4722::setup_window("Rotate About Center", .9);
